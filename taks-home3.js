...
/* 3. Buat array berdasarkan script pada link diatas yang 
menyimpan keuntungan yang didapat dari setiap transaksi*/
...
const dataBaru = data.map((d) => {
    ...
    for (const dataBarang of d.items) {
        total =
            total +
            dataBarang.price.$numberDecimal * dataBarang.quantity.$numberInt;
    }
