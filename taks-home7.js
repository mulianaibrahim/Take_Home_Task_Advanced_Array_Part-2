...
arrOmzet = []
const omzetMin = data.reduce(function (d) {
    const maxRev = data.map(function (d) {
        let totalRev = 0;
        data.forEach(e => {
 ...
 const omzetMax = data.find(function (d) {
    let totalRev = 0;
    data.forEach(e => {
        totalRev = totalRev + d.items[0].price * d.items[0].qty
    });
...
console.log(`omzet terbesar : USD ${arrOmzet[0]}`)
console.log(`omzet terkecil : USD ${arrOmzet[arrOmzet.length-1]}`)
